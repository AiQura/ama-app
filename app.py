...
def main():
    ...
    with st.sidebar:
        ...
        st.write("Upload the PDF files that you will ask about information in it, then click upload selected files button.")
        if current_user:
        ...
        st.header("Add Links")
        st.write("Add the website links that you will ask about information in it, then click add link button")
